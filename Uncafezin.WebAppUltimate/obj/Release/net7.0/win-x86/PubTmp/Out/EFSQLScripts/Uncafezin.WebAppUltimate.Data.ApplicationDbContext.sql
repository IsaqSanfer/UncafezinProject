...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20231116035103_Initial')
BEGIN
...
BEGIN
    CREATE TABLE [ProductViewModel] (
        ...
        CONSTRAINT [PK_ProductViewModel] PRIMARY KEY ([Id])
    );
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20231116035103_Initial', N'7.0.13');
END;
GO
