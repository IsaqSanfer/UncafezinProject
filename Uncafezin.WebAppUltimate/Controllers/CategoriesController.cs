...
namespace Uncafezin.WebAppUltimate.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(UltimateContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Category != null ? 
                          ...
                          Problem("Entity set 'UltimateContext.Category'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UltimateContext.Category'  is null.");
            }
            var category = await _context.Category.FindAsync(id);
            if (category != null)
            {
